...
class Setup extends DolibarrApi
{
     ...
     * code supported by  Baterias, for example 'en_US' or 'fr_FR'.
    ...
    function getCheckIntegrity($target)
    {
    	...
    	if (empty($xmlremote)) $xmlremote = 'http://www.bateriasecuador.com/files/stable/signatures/filelist-'.DOL_VERSION.'.xml';
