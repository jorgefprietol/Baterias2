...
<div align="center">
  <img class="imgdoc" src="http://www.bateriasecuador.com//images/doc_apirest.png" alt="Dolibarr API explorer"/>
</div>
...
To implement it into  Baterias, you need to create a specific class for object we want to use. A skeleton file is available into /modulebuilder/class directory : *api_mymodule_class.class.php* 
