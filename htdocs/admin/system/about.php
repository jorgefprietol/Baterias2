...
print '<li>'.$langs->trans("SeeWikiForAllTeam").': <a href="http://www.bateriasecuador.com//index.php/Dolibarr_Project" target="_blank" rel="external">http://www.bateriasecuador.com//index.php/Dolibarr_Project</a></li>';
print '</ul>';
...
print '<ul>';
print '<li>';
print '<a target="_blank" href="http://www.bateriasecuador.com/" rel="external">'.$langs->trans("OfficialWebSite").'</a>';
print '</li>';
// Show local site
...
print '<li>';
print '<a target="_blank" href="http://www.bateriasecuador.com//" rel="external">'.$langs->trans("OfficialWiki").'</a>';
print '</li>';
print '</ul>';
...
print '<ul>';
print '<li>';
print '<a target="_blank" href="http://www.bateriasecuador.com/onlinedemo/" rel="external">'.$langs->trans("OfficialDemo").'</a>';
print '</li>';
print '</ul>';
...
print '<ul>';
print '<li>';
print '<a target="_blank" href="http://www.bateriasecuador.com/" rel="external">'.$langs->trans("OfficialMarketPlace").'</a>';
print '</li>';
print '</ul>';
...
print '<ul>';
$url='http://www.bateriasecuador.com//index.php/Subscribe';
if (preg_match('/^fr_/i',$langs->getDefaultLang())) $url='http://www.bateriasecuador.com//index.php/Adh%C3%A9rer';
if (preg_match('/^es_/i',$langs->getDefaultLang())) $url='http://www.bateriasecuador.com//index.php/Subscribirse';
...
if (preg_match('/^fr_/i',$langs->getDefaultLang())) $url='http://www.bateriasecuador.com//index.php/Solutions_de_Cloud';
if (preg_match('/^es_/i',$langs->getDefaultLang())) $url='http://www.bateriasecuador.com//index.php/Soluciones_en_la_Nube';
print '<li>';
