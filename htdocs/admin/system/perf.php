...
print $langs->trans("YouMayFindPerfAdviceHere",'http://www.bateriasecuador.com//index.php/FAQ_Increase_Performance').' (<a href="'.$_SERVER["PHP_SELF"].'">'.$langs->trans("Reload").'</a>)<br>';
