...
if (! defined('DOL_APPLICATION_TITLE')) define('DOL_APPLICATION_TITLE','Baterias');
if (! defined('DOL_VERSION')) define('DOL_VERSION','1.0.2');		// a.b.c-alpha, a.b.c-beta, a.b.c-rcX or a.b.c
...
$tmp='';
$found=0;
$real_dolibarr_main_document_root=str_replace('\\','/',realpath($dolibarr_main_document_root));	// A) Value found into config file, to say where are store htdocs files. Ex: C:/xxx/ Baterias, C:/xxx/dolibarr/htdocs
if (!empty($_SERVER["DOCUMENT_ROOT"])) {
    $pathroot = $_SERVER["DOCUMENT_ROOT"];                                                      // B) Value reported by web server setup (not defined on CLI mode), to say where is root of web server instance. Ex: C:/xxx/ Baterias, C:/xxx/dolibarr/htdocs
} else {
    $pathroot = 'NOTDEFINED';
}
...
define('DOL_MAIN_URL_ROOT', $tmp);											// URL absolute root (https://sss/ Baterias, ...)
