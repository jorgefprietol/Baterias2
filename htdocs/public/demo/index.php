...
print '<a alt="Official portal of your ERP CRM application" targe="_blank" href="http://www.bateriasecuador.com/"><img class="demologo" src="'.DOL_URL_ROOT.'/theme/logo_bateriasec.svg" alt="Dolibarr logo"></a>';
print '</div>';
print '</div>';
