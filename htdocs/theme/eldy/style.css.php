...
a:link, a:visited, a:hover, a:active { font-family: <?php print $fontlist ?>; font-weight: normal; color: rgb(#fff); text-decoration: none;  }
a:hover { text-decoration: underline; color: rgb(#fff); }
a.commonlink { color: rgb(#fff) !important; text-decoration: none; }
...
.treeview .hover { color: rgb(#fff) !important; text-decoration: underline !important; }
