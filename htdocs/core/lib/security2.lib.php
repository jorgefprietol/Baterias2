...
if (! function_exists('dol_loginfunction'))
{
    ...
    function dol_loginfunction($langs,$conf,$mysoc)
	{
		...
		*/
		...
		elseif (is_readable(DOL_DOCUMENT_ROOT.'/theme/'.$conf->theme.'/img/logo_bateriasec.svg'))
		{
			$urllogo=DOL_URL_ROOT.'/theme/'.$conf->theme.'/img/logo_bateriasec.svg';
		}
		elseif (is_readable(DOL_DOCUMENT_ROOT.'/theme/logo_bateriasec.svg'))
		{
			$urllogo=DOL_URL_ROOT.'/theme/logo_bateriasec.svg';
		}
