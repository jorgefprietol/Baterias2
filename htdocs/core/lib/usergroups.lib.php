...
function show_theme($fuser,$edit=0,$foruserprofile=false)
{
	...
	else
	{
		...
		$url='http://www.bateriasecuador.com//lang-en/4-skins';
		if (preg_match('/fr/i',$langs->defaultlang)) $url='http://www.bateriasecuador.com//fr/4-themes';
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				//print '<span style="color: #e21e26">'.$langs->trans("Default").'</span>';
				print $langs->trans("Default");
			}
		}
		print ' &nbsp; <span class="nowraponall">('.$langs->trans("Default").': <strong><span style="color: #e21e26">e21e26</span></strong>) ';
		print $form->textwithpicto('', $langs->trans("NotSupportedByAllThemes").', '.$langs->trans("PressF5AfterChangingThis"));
		print '</span>';
		print '</td>';
		print '</tr>';
