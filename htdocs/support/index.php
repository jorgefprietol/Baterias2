...
$urlwiki='http://www.bateriasecuador.com/';
if (preg_match('/fr/i',$langs->defaultlang)) $urlwiki='http://www.bateriasecuador.com//index.php/Accueil';
if (preg_match('/es/i',$langs->defaultlang)) $urlwiki='http://www.bateriasecuador.com//index.php/Portada';
print '<br>'.$langs->trans("ForDocumentationSeeWiki",$urlwiki,$urlwiki);
print '<br>';
$urlforum='http://www.bateriasecuador.com/forum/';
$urlforumlocal='http://www.bateriasecuador.com/forum/';
if (preg_match('/fr/i',$langs->defaultlang)) $urlforumlocal='http://www.bateriasecuador.com/';
if (preg_match('/es/i',$langs->defaultlang)) $urlforumlocal='http://www.bateriasecuador.com/';
if (preg_match('/it/i',$langs->defaultlang)) $urlforumlocal='http://www.bateriasecuador.com/';
if (preg_match('/gr/i',$langs->defaultlang)) $urlforumlocal='http://www.bateriasecuador.com//';
