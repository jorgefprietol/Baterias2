...
AppSupportURL=http://www.bateriasecuador.com/
AppUpdatesURL=http://www.bateriasecuador.com/
AppComments=DoliWamp includes  Baterias, Apache, PHP and Mysql softwares.
...
//	    end;
      ...
      begin
		    ...
		    destFile := pathWithSlashes+'/www/Baterias/htdocs/install/install.forced.php';
		    srcFile := pathWithSlashes+'/www/Baterias/htdocs/install/install.forced.php.install';
