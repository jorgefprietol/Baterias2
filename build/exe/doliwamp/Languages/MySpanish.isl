...
IfYouHaveTechnicalKnowledge=Si tiene conocimientos t�cnicos y necesita usar su Apache, Mysql y PHP con otras aplicaciones aparte d Baterias,r, no deber�a usar este asistente, deber�a realizar una instalaci�n manual de Dolibarr sobre un Apache, Mysql y PHP existente.
ButIfYouLook=Pero si busca una instalaci�n autom�tica, se encuentra en el buen camino...
DoYouWantToStart=�Quiere iniciar el proceso de instalaci�n/actualizaci�n?
...
MySqlPassword=Contrase�a del servidor y la base de datos MySQL de root (�nicamente primera instalaci�n):
...
DoliWampWillStartApacheMysql=El instalador DoliWamp intentar� iniciar o reiniciar Apache y MySQL, esto puede durar desde varios segundos a un minuto despu�s de la confirmaci�n. �Iniciar la instalaci�n o actualizaci�n de los servidores Web y bases de datos requeridas por Dolibarr?
