...
YouWillInstallDoliWamp=Vous allez installer ou mettre � jour DoliWamp sur votre ordinateur (donc Dolibarr + tous ses composants pr�requis comme Apache, Mysql et PHP).
ThisAssistantInstallOrUpgrade=AVERTISSEMENT: L'utilisation d'un ERP CRM install� sur un ordinateur local peut �tre dangereuse: si votre ordinateur tombe en panne, vous pouvez perdre toutes vos donn�es. Faites-le si vous �tes pr�t � g�rer les sauvegardes vous-m�me s�rieusement. Sinon, utilisez plut�t une installation en Saas (voir https://saas.dolibarr.org).
IfYouHaveTechnicalKnowledge=De plus, si vous avez des comp�tences techniques et envisagez de partager votre Apache, Mysql et PHP avec d''autres applications qu Baterias,r, vous ne devriez pas utiliser cet assistant mais faire plut�t une installation manuelle de Dolibarr sur un serveur existant �quip� de Apache, Mysql et PHP.
...
DLLMissing=L'installation de votre Windows est incompl�te. Il manque le composant "Micrsoft Visual C++ Redistributable for Visual Studio 2012". Installer la version 32-bit (vcredist_x86.exe) d'abord (vous pourrez le trouver � https://www.microsoft.com/fr-fr/download/) puis relancer l'installation de DoliWamp apr�s.
