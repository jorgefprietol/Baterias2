...
<PADGEN_PML>
	...
	<Program_Descriptions>
		<English>
			<Keywords> Baterias, erp, crm, invoices, commercial proposals, orders, accounting, stock, products, agenda, bank, business, company, foundation, management, sme, doliwamp</Keywords>
...
Dolibarr intègre en effet sa propre architecture (design patterns) permettant à tout développeur d'être tout de suite opérationnel sans connaissances particulières autre que le PHP. </Char_Desc_2000>
	...
	<Web_Info>
		<Application_URLs>
			...
			<Application_XML_File_URL>http://www.bateriasecuador.com/files/pad_dolibarr.xml</Application_XML_File_URL>
		</Application_URLs>
		<Download_URLs>
			<Primary_Download_URL>http://www.bateriasecuador.com/files/dolibarr.tgz</Primary_Download_URL>
			<Secondary_Download_URL>http://www.bateriasecuador.com/files/dolibarr.tgz</Secondary_Download_URL>
