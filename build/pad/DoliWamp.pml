...
<PADGEN_PML>
	...
	<Program_Descriptions>
		<English>
			<Keywords>doliwamp,  Baterias, erp, crm, invoices, commercial proposals, orders, accounting, stock, products, agenda, bank, business, company, foundation, management</Keywords>
...
DoliWamp is the auto-installer for Windows users with no technical knowledge to install Dolibarr ERP/CRM and all its prerequisites (Apache, Mysql, PHP) with just one auto-exe file.</Char_Desc_2000>
		...
		<French>
			<Keywords>doliwamp,  Baterias, erp, crm, factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations, entreprises, PME, TPE</Keywords>
		...
		<Italian>
			<Keywords>doliwamp,  Baterias, erp, crm, gestionale, medie imprese, fondazioni</Keywords>
	...
	<Web_Info>
		<Application_URLs>
			...
			<Application_Screenshot_URL>http://www.bateriasecuador.com/images/dolibarr_screenshot1.png</Application_Screenshot_URL>
			<Application_Icon_URL>http://www.bateriasecuador.com/images/dolibarr.gif</Application_Icon_URL>
			<Application_XML_File_URL>http://www.bateriasecuador.com/files/pad_doliwamp.xml</Application_XML_File_URL>
		</Application_URLs>
		<Download_URLs>
			<Primary_Download_URL>http://www.bateriasecuador.com/files/doliwamp.exe</Primary_Download_URL>
			<Secondary_Download_URL>http://www.bateriasecuador.com/files/doliwamp.exe</Secondary_Download_URL>
