...
URL: http://www.bateriasecuador.com/
%if 0%{?fedora} || 0%{?rhel_version} || 0%{?centos_version}
Source0: http://www.bateriasecuador.com/files/lastbuild/package_rpm_redhat-fedora/%{name}-%{version}.tgz
%else
%if 0%{?mdkversion}
Source0: http://www.bateriasecuador.com/files/lastbuild/package_rpm_mandriva/%{name}-%{version}.tgz
%else
%if 0%{?suse_version}
Source0: http://www.bateriasecuador.com/files/lastbuild/package_rpm_opensuse/%{name}-%{version}.tgz
%else
Source0: http://www.bateriasecuador.com/files/lastbuild/package_rpm_generic/%{name}-%{version}.tgz
%endif
%endif
%endif
...
echo "To finish installation and use  Baterias, click on the menu" 
