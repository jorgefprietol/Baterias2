...
# Returns a list of files needed by  Baterias, each of which is a hash ref
...
# Actually installs  Baterias, and returns either 1 and an informational
...
{
return 'http://www.bateriasecuador.com/';
}
